...
# Description
A quick introduction into path traversal with my pets.
...
The second method would be directly path traversal from HTML elements. If you have noticed during the change of the HTML tag the source is `src="/image/content?img=../flag.txt"`. 
